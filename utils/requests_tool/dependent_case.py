...
from utils.mysql_tool.mysql_handler import SetUpMySQL
from utils.read_files_tools.regular_handler import regular, cache_regular
            ...
            try:
                for dependence_case_data in _dependence_case_dates:
                    ...
                    if _case_id == 'self':
                        ...
                        res = RequestHandler(re_data).http_request()
