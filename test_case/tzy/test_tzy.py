...
case_id = ['tzy_sso_email_login_01']
...
class TestTzy:
    ...
    def test_tzy(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_tzy.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
